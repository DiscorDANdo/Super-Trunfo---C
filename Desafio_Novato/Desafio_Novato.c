...
int main() {
    // Carta 1
        ...
        printf(
            ...
            "PIB: %.2f\n"
            "Pontos turisticos: %d\n",
            codigo_carta1, estado_carta1, cidade_carta1, populacao_carta1, area_em_km2_carta1, pib_carta1, pontos_turisticos_carta1);
        printf("============================================================================\n");
        ...
        printf(
            ...
            "PIB: %.2f\n"
            "Pontos turisticos: %d\n",
            codigo_carta2, estado_carta2, cidade_carta2, populacao_carta2, area_em_km2_carta2, pib_carta2, pontos_turisticos_carta2);
        printf("============================================================================\n");
